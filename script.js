...
const translations = {
  en: {
    ...
    premium_desc: "Handpicked styles from top designers",
    easy_ordering: "Easy Ordering",
    ordering_desc: "Chat with us and order in seconds",
    fast_shipping: "Fast Shipping",
    shipping_desc: "Quick delivery to your doorstep",
    secure_experience: "Secure Experience",
    secure_desc: "Trusted by over 5,000+ customers",
    ...
    testimonials_sub: "Join thousands of satisfied shoppers who trust Mony Store for their style needs.",
    testi_1_text:
  ...
  ar: {
    ...
    premium_desc: "تصميمات مختارة بعناية من أفضل المصممين",
    easy_ordering: "طلب سهل وسريع",
    ordering_desc: "تواصل معنا واطلب في ثوانٍ",
    fast_shipping: "شحن سريع",
    shipping_desc: "توصيل سريع حتى باب منزلك",
    secure_experience: "تجربة آمنة",
    secure_desc: "موثوق به من قبل أكثر من 5,000 عميل",
    ...
    testimonials_sub: "انضم إلى آلاف المتسوقين الراضين الذين يثقون في موني ستور لاحتياجاتهم من الأناقة.",
    testi_1_text:
